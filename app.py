...
<head>
    ...
    <style>
        ...
        .chat-card { background: white; width: 100%; max-width: 400px; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); overflow: hidden; display: flex; flex-direction: column; height: 80vh; }
    ...
    <script>
        async function askBot() {
            ...
            try {
                ...
                chatBox.innerHTML += `<div class="msg bot">وقع مشكل، عاود جرب دابا شوية.</div>`;
            }
...
def ask():
    try:
        ...
        response = chat.send_message("أنت مساعد إداري مغربي، أجب باختصار بالدارجة أو العربية: " + user_prompt)
        return jsonify({'answer': response.text})
    except Exception as e:
        return jsonify({'answer': "خطأ في الاتصال: " + str(e)})
